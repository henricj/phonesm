...
md Libraries\
md Libraries\SM.Media.BackgroundAudioStreamingAgent.WP7\
...
md Phone\BackgroundAudio.Sample.WP7\Images\
md Phone\BackgroundAudio.Sample.WP7\Properties\
...
md Phone\SamplePlayer.WP7\
md Phone\SamplePlayer.WP7\Properties\
