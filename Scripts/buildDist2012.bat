"%~dp0..\Distribution\.nuget\NuGet.exe" restore "%~dp0..\Distribution\Samples.WP7.sln"
"%~dp0..\Distribution\.nuget\NuGet.exe" restore "%~dp0..\Distribution\Samples.WP8.sln"
"%~dp0..\Distribution\.nuget\NuGet.exe" restore "%~dp0..\Distribution\Sample.Silverlight.sln"
